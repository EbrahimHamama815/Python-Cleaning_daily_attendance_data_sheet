...
In this free lance project, the client gets an attendance sheet from an automated gate system to track employees, how ever the client needs to extract some insights.

At its current state the sheet is hard to deal with, here is an example:
<br>
